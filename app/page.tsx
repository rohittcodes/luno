...
import { GradientTexture } from '@/components/landing/gradient-texture'
...
function LandingPage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 md:pb-32">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left Column - Text Content */}
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-primary/10 border-2 border-primary/20 text-base font-semibold mb-8 backdrop-blur-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center lg:items-start lg:justify-start justify-center gap-4 mb-12">
                <Button size="lg" asChild className="text-lg px-10 py-7 h-auto rounded-[3rem] font-bold shadow-2xl hover:shadow-3xl transition-all text-primary-foreground">
                  <Link href="/signup">
                    Get Started Free
                    <ArrowRight className="ml-3 h-5 w-5" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" asChild className="text-lg px-10 py-7 h-auto rounded-[3rem] font-bold border-[3px]">
                  <Link href="/blog">Read Blog</Link>
                </Button>
              </div>

              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 sm:gap-8 text-base font-semibold">
          ...
          {/* Mobile Cards - Below text on small screens */}
      ...
      {/* Features Section */}
      <section id="features" className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 max-w-7xl mx-auto">
          <Card className="relative rounded-[2.5rem] border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl group overflow-hidden">
      ...
      <section id="pricing" className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 max-w-7xl mx-auto">
            {/* Free Plan */}
            <Card className="rounded-[3rem] border-2 hover:shadow-2xl transition-all duration-300">
            ...
            {/* Pro Plan */}
            <Card className="rounded-[3rem] border-primary border-[3px] shadow-xl relative overflow-hidden scale-105 hover:scale-110 transition-all duration-300">
